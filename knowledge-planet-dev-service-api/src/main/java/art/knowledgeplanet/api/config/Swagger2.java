package art.knowledgeplanet.api.config;
...
//                .apis(Predicates.or(adminPredicate, articlePredicate, userPredicate, filesPredicate))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Knowledge Planet API")                       // 文档页标题
                .contact(new Contact("Ethan",
                        "https://www.knowledgeplanet.art",
                        ""))                   // 联系人信息
                .description("API documentation for Knowledge Planet")      // 详细信息
                .version("1.0.1")                               // 文档版本号
                .termsOfServiceUrl("https://www.knowledgeplanet.art")     // 网站地址
                .build();
    }
}